...
public class FatosMapSDKSampleFragment extends AMapBaseFragment {
    ...
    private Button m_test10Btn, m_test11Btn, m_test12Btn;
    ...
    public FatosMapSDKSampleFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.amap_test_btn, parent, false);
...
/**
                ...
                ((FatosMapBaseSDKActivity) getActivity()).updateCancelRoute();

                //((FatosMapBaseSDKActivity) getActivity()).showTbtLayout(true);
        ...
        m_test2Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //m_FMInterface.FM_SearchPOI_Hybrid(new HttpResultHandler(FatosMapSDKSampleFragment.this),"서울",false);
                //((FatosMapBaseSDKActivity) getActivity()).showTbtLayout(false);
        ...
        m_test3Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    ((FatosMapBaseSDKActivity) getActivity()).manualReRouteMenu();
            ...
            public void onClick(View v) {
                ...
                switch(m_gApp.getRoutePathInfo().m_nServiceType) {
                    case FatosBuildConfig.FATOS_SITE_IS_LGD:
                        ...
                        break;
                    default:
                        m_FMInterface.FM_RouteVol2_Hybrid(new HttpResultHandler(FatosMapSDKSampleFragment.this),null,endPos,routeOpt);
                        break;
                }
            }
        });
        ...
        m_test5Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                m_FMInterface.FM_GetAddress(new HttpResultHandler(FatosMapSDKSampleFragment.this),latlon[1], latlon[0]);
            }
        });
        ...
        m_test6Btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                m_FMInterface.FM_RecommendWord(new HttpResultHandler(FatosMapSDKSampleFragment.this),"ㄱ");
            }
        });
        ...
        editText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if(editText.getText().length() > 0 && FatosBuildConfig.getBuildSearchResultMode() == 1)
                {
                    ...
                    m_FMInterface.FM_RecommendWord(new HttpResultHandler(FatosMapSDKSampleFragment.this),strData);
                    /*
...
//		Date curDate = now.getTime();
    ...
    static class HttpResultHandler extends Handler {
        private final WeakReference<FatosMapSDKSampleFragment> mActivity;

        HttpResultHandler(FatosMapSDKSampleFragment activity) {
            mActivity = new WeakReference<FatosMapSDKSampleFragment>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            FatosMapSDKSampleFragment activity = mActivity.get();
            if (activity != null) {
