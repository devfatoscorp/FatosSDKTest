...
public class FatosMapBaseSDKDriveLocalActivity extends FMBaseActivity implements FMBaseActivity.OnFatosMapBaseActivityListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fatos_map_base_drive_local_sdk);
...
//                startPos.strAddr = "여의도";
        ...
        m_FMInterface.FM_RouteVol2_Local(null,endPos,routeOpt);
